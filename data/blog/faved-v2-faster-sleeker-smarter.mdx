...
> [!TIP]
> As always, you can get a sneak peek of the latest version by visiting our <a href={siteMetadata.demoUrl} target="_blank" rel="noopener">Live Demo</a>.
...
{/* Bypass Cloudflare Transformation as image is too big to be processed */}

<img
  alt="Sorting"
  src="/static/images/posts/faved-v2-faster-sleeker-smarter/sorting-ss-1080p-15fps.gif"
/>
Keep your bookmarks neatly organized with flexible sorting options. You can sort by creation date,
last updated date, title, description, URL, or comments, making it easy to surface the most relevant
or recently added links at the top.

### Card Layout

![Switching layouts](/static/images/posts/faved-v2-faster-sleeker-smarter/layouts-ss-1080p-15fps-no-zoom.gif)
...
<img
  alt="Switch dark and light mode"
  src="/static/images/posts/faved-v2-faster-sleeker-smarter/dark-light-ss-1080p-15fps-no-zoom.gif"
/>
...
<img
  ...
  src="/static/images/posts/faved-v2-faster-sleeker-smarter/wizard-ss-1080p-15fps-no-zoom.gif"
/>
...
To enjoy these new features, simply follow the [step-by-step instructions](/docs/getting-started/updating) to update your Faved instance to the latest version.
