...
> [!NOTE]
> This guide applies to the self-hosted version of Faved only. If you're on [Faved Cloud](https://app.faved.to/signup), there's nothing to install — your instance is ready to use right after signup.
